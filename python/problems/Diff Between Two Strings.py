...
# Actual ['H', '+L', '-M', '-X', '-P', '-H', '-H', '-U', '-M', '+Z', '+P', '+L', '+U', '+P', '+H']
# Expect ["H", "-M", "-X", "+L", "+Z", "P",  "-H", "-H", "+L", "U",  "-M", "+P", "+H"]

print(diffBetweenTwoStrings("HMXPHHUM", "HH"))
print(diffBetweenTwoStrings("GHMXGHUGXL", "PPGGXHHULL"))
